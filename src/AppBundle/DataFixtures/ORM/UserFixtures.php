...
class UserFixtures extends Fixture
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $user->setLevel($this->getReference('level7'));
        $user->addInstitution($this->getReference('etabl1'));
        ...
        $user2->setLevel($this->getReference('level7'));
        $user2->addInstitution($this->getReference('etabl1'));
        ...
        $user3->setLevel($this->getReference('level3'));
        $user3->addInstitution($this->getReference('etabl1'));
        ...
        $user4->setLevel($this->getReference('level1'));
        $user4->addInstitution($this->getReference('etabl1'));
        ...
        $user5->setLevel($this->getReference('level1'));
        $user5->addInstitution($this->getReference('etabl1'));
        ...
        $user6->setLevel($this->getReference('level2'));
        $user6->addInstitution($this->getReference('etabl1'));
        ...
        $user7->setLevel($this->getReference('level4'));
        $user7->addInstitution($this->getReference('etabl2'));
        ...
        $user8->setLevel($this->getReference('level5'));
        $user8->addInstitution($this->getReference('etabl2'));
